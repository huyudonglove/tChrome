...
test("turn process joins existing records without mixing turns or mutable memory/notes",()=>{
 ...
 first.assembled.pageObservedHistory=[{id:"p1",turnId:"tn_01",tabId:1,url:"https://example.com",title:"任务",description:"已修改",observedAt:"2026-09-11",callId:"c0",toolName:"page.get_summary"}];
