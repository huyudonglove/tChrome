...
test("turn process joins existing records without mixing turns or mutable memory/notes",()=>{
 ...
 ledger.goalHistory=[{id:"g1",turnId:"tn_01",goal:"修改负责人",sourceCallId:"c1",createdAt:"2026-09-11"}];
 ledger.goal={id:"g2",turnId:"tn_02",goal:"另一目标",sourceCallId:"c2",createdAt:"2026-09-11"};
 ...
 expect(record.toolIO).toHaveLength(1);expect(record.goalChanges).toEqual(ledger.goalHistory);
